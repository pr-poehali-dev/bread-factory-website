...
const PRODUCTS = [
  ...
  { id: 44, name: "Батон «Колос»", category: "Сдобная выпечка", price: 0, weight: "", calories: "", composition: "", shelf: "", description: "", badge: null, image: "🥖" },
  { id: 45, name: "Булочка «Веснушка»", category: "Сдобная выпечка", price: 0, weight: "", calories: "", composition: "", shelf: "", description: "", badge: null, image: "🧁" },
  { id: 46, name: "Саечка", category: "Сдобная выпечка", price: 0, weight: "", calories: "", composition: "", shelf: "", description: "", badge: null, image: "🧁" },
  { id: 47, name: "Булочка «Посыпушка»", category: "Сдобная выпечка", price: 0, weight: "", calories: "", composition: "", shelf: "", description: "", badge: null, image: "🧁" },
  { id: 48, name: "Рогалик", category: "Сдобная выпечка", price: 0, weight: "", calories: "", composition: "", shelf: "", description: "", badge: null, image: "🥐" },
  { id: 49, name: "Ромашка в ассортименте", category: "Сдобная выпечка", price: 0, weight: "", calories: "", composition: "", shelf: "", description: "", badge: null, image: "🧁" },
