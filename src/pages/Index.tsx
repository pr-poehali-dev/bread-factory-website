...
const PRODUCTS = [
  {
    ...
    composition: "Мука ржаная, вода, солод, кориандр, соль",
    shelf: "5 суток",
    description: "Классический бородинский хлеб по традиционному рецепту с кориандром. Плотный мякиш, ароматная корочка.",
    badge: "Хит продаж",
    image: "🍞",
  },
  {
  ...
  },
  {
    ...
    shelf: "4 суток",
    description: "Деревенский хлеб из смеси пшеничной и ржаной муки. Насыщенный вкус, плотная структура.",
    badge: "Новинка",
    image: "🫓",
  },
  {
    id: 4,
    name: "Хлеб «Зерновой»",
    category: "Зерновой хлеб",
    price: 112,
    weight: "500 г",
    calories: "248 ккал/100г",
    composition: "Мука цельнозерновая, семена подсолнечника, тыквы, льна, кунжут",
    shelf: "4 суток",
    description: "Полезный хлеб с цельнозерновой мукой и смесью семян. Богат клетчаткой и витаминами.",
    badge: null,
    image: "🌾",
  },
  {
